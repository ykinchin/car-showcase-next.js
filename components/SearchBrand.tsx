...
type SearchBrandProps = { brand: string; setBrand: (brand: string) => void }

const SearchBrand: FC<SearchBrandProps> = ({ brand, setBrand }) => {
              ...
              {filteredBrands.length === 0 && query !== '' ? (
                ...
                filteredBrands.map((item) => (
                  <Combobox.Option
                    key={item}
                    className={({ active }) =>
                      `relative cursor-default select-none py-2 pl-10 pr-20 ${
